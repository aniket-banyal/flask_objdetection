...
MODEL_BASE = r'C:\Users\a\Desktop\objD\models\research'
...
BASE_CKPT = 'C:/Users/a/Desktop/objD/flask_objectdetection_app-master/ckpts/' 
...
def imgproc():
  ...
  if request.method == 'POST' and form.validate():
    ...
    photo_form = PhotoForm(request.form)
    return render_template('main.html', photo_form=photo_form, video_form=video_form, models=MODELS.keys(), result=result)
  else:
